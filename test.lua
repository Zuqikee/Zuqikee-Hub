...
spawn(function() 
    ...
    wait(.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Thì Zuqikee Hub đã trở lại!!!!!<Color=/>"):Display()
    wait(.14)
...
local Window = OrionLib:MakeWindow({Name = "Zuqikee Hub", HidePremium = false, IntroText = "ZuqikeeHub Library", SaveConfig = true, ConfigFolder = "Zuqikee Hub"})

OrionLib:MakeNotification({
	Name = "Zuqikee Hub",
	Content = "Choose Teams Bro?",
	Image = "rbxassetid://17426163835",
	Time = 7
})

OrionLib:MakeNotification({
	Name = "Zuqikee Hub",
	Content = "Zuqikee Hub Not Skidder, Please don't says",
	Image = "rbxassetid://17426163835",
	Time = 25
})
...
W:AddLabel("[+] Zuqikee Hub is back!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Zuqikee Hub(Noitification)",
